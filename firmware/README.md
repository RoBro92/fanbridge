...
UF2_URL="https://github.com/RoBro92/fanbridge/releases/download/fw-v2.2.0/fanbridge-rp2040-2.2.0.uf2" && \
...
wget -O /tmp/fanbridge.uf2 \
  "https://github.com/RoBro92/fanbridge/releases/download/fw-v2.2.0/fanbridge-rp2040-2.2.0.uf2"
...
1. **Download UF2 Firmware**: [Download v2.2.0](https://github.com/RoBro92/fanbridge/releases/download/fw-v2.2.0/fanbridge-rp2040-2.2.0.uf2) or check for [newer versions](https://github.com/RoBro92/fanbridge/releases).
